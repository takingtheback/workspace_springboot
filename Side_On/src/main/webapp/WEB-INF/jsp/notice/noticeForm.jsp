                				...
                				<table class="table table-striped" style="text-align: center; border: 1px solid #dddddd;">
                					...
                					<tbody>
                						<tr>
                							...
                							<input type="text" placeholder="글 제목" name="noticeTitle" style="width: 700px; height: 50px;"/>
                							</td>
                							
                						</tr>
                						<tr>
                							<td colspan="6" style="background-color:#fff; text-align: center; height: 350px;">
                							<input type="text" placeholder="내용을 입력하세요." name="noticeContent" style="width: 700px; height: 350px;"/>
                							</td>
                						</tr>
